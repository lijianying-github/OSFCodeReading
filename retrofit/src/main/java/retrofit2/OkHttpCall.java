...
final class OkHttpCall<T> implements Call<T> {
    ...
    /**
     * 创建原始的call 也就是okhttp的call,okhttp 的call需要request对象
     *
     * @return okhttp call
     * @throws IOException
     */
    ...
    /**
     * 将okhttp response转换成retrofit 的response
     *
     * @param rawResponse okhttp response
    ...
    Response<T> parseResponse(okhttp3.Response rawResponse) throws IOException {
        ...
        //http code 204,205表示内有内容
        //204 只要若干首部和状态行没有实体的内容主体，就是没有内容
        //205 表单重置
