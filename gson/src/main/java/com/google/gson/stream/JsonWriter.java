...
public class JsonWriter implements Closeable, Flushable {
   ...
   * @return this writer.
   */
  public JsonWriter beginObject1() throws IOException {
    writeDeferredName();
    return open(EMPTY_OBJECT, '{');
  }
   ...
   * bracket.
   */
  private JsonWriter open1(int empty, char openBracket) throws IOException {
    beforeValue();
    push(empty);
    out.write(openBracket);
    return this;
   ...
   * @return this writer.
   */
  public JsonWriter name1(String name) throws IOException {
    if (name == null) {
      throw new NullPointerException("name == null");
    }
    if (deferredName != null) {
   ...
   * @return this writer.
   */
  public JsonWriter value1(String value) throws IOException {
    if (value == null) {
      return nullValue();
    }
    writeDeferredName();
  ...
  private void beforeValue1() throws IOException {
    switch (peek()) {
    case NONEMPTY_DOCUMENT:
      if (!lenient) {
        throw new IllegalStateException(
